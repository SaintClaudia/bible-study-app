        ...
        <div className="mt-3 grid grid-cols-2 gap-3">
          {subItems.map((item, i) => (
            ...
            >
              ...
              <div className="p-3">
                <p className="font-heading text-base font-normal leading-snug text-foreground">
                  {item.title}
                </p>
        ...
        <div className="overflow-hidden rounded-2xl border border-border bg-card">
          {goodToKnowItems.map((item, i) => (
            ...
            >
              ...
              <div className="flex-1">
                <p className="font-heading text-lg font-normal text-foreground">{item.title}</p>
                <p className="text-xs leading-relaxed text-muted-foreground">{item.subtitle}</p>
              </div>
              <ChevronRight className="h-4 w-4 shrink-0 text-muted-foreground" />
            </button>
          ))}
